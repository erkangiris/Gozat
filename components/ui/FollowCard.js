...
export default function FollowCard({ name, image, url, follower, isFollow, className, type }) {
    return (
        <div className={`w-full flex items-center bg-card-bg bg-opacity-70 rounded-lg ${type === "big" ? 'flex-col justify-center p-10 text-center' : 'justify-between p-3'} ${className}`}>
